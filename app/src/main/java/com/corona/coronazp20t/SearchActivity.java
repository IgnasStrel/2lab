...
public class SearchActivity extends AppCompatActivity {
    public static final String MARGARITA_API_URL = "\n" + "https://www.thecocktaildb.com/api/json/v1/1/search.php?s=Margarita";

    private RecyclerView recyclerView;
    private Adapter adapter;

    private ArrayList<Margarita> margaritaArrayList = new ArrayList<Margarita>();
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (Intent.ACTION_SEARCH.equals(intent.getAction())) {
            ...
            ArrayList<Margarita> margaritaListByName = JSON.getMargaritaListByName(margaritaArrayList, query);

            if (margaritaListByName.size() == 0) {
            ...
            adapter = new Adapter(SearchActivity.this, margaritaListByName);
    ...
    private class AsyncFetch extends AsyncTask<String, String, ArrayList<Margarita>> {
        ...
        protected ArrayList<Margarita> doInBackground(String... params) {
            try {
                JSONObject jsonObject = JSON.readJsonFromUrl(MARGARITA_API_URL);
                margaritaArrayList = JSON.getList(jsonObject);
        ...
        @Override
        protected void onPostExecute(ArrayList<Margarita> margaritaArrayList) {
            //this method will be running on UI thread
            pdLoading.dismiss();

           if(margaritaArrayList != null) {
               Toast.makeText(SearchActivity.this, getResources().getString(R.string.search_found_entries_from_api) + margaritaArrayList.size(), Toast.LENGTH_SHORT).show();
           }
        }//onPostExecute
    }//AsyncFetch class
}
